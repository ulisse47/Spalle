 ...
 */
public class PalificataOutputDataPanel extends AbstractInputPanel {

	private static PalificataOutputDataPanel panel;

	public static synchronized PalificataOutputDataPanel getInstance() {
		if (panel == null) {
			panel = new PalificataOutputDataPanel();
		}
		return panel;
	}
...
//		addInputField(pTerrenoCLS, new DefaultDoubleField(width), 1, 0, "y_verifica", "coordinata y sezione di verifica(cm)");		
	 ...
	 *  
	 */
	private PalificataOutputDataPanel() {
		super();
	}
