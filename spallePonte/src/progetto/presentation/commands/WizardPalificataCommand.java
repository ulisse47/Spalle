 ...
 */
public class WizardPalificataCommand implements Command, RequestDispatcherInt {
    ...
    public synchronized RequestDispatcherInt execute(RequestHelper helper) throws Exception,
        ...
        try {
            ...
            new FondazioniViewAction().actionPerformed(new ActionEvent(new WizardPalificataCommand(), 0, "wizard palificata"));
