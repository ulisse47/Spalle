 ...
 */
public class SalvaPalificataCommand implements Command,
	...
	public synchronized RequestDispatcherInt execute(RequestHelper helper)
		...
		try {
			...
			AbstractBaseTableModel model = (AbstractBaseTableModel) TablePali
			...
			if (model.getRowCount() != 0) {
				...
				bDelegate.salvaPalificata(model.getRowData());
			}
