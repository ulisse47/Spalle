 ...
 */
public class AddStratoTerrenoCommand implements Command, RequestDispatcherInt {
    ...
    public String getDisplayMessage(Properties properties) {
        return "Aggiunto Starto Terreno";
    }
    ...
    public synchronized RequestDispatcherInt execute(RequestHelper helper) throws Exception,
        ...
        try {
            ...
            new PortanzaViewAction().actionPerformed(new ActionEvent(new AddStratoTerrenoCommand(), 0, "Add strato"));

            bDelegate.addStratoTerreno();
