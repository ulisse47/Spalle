...
public class SalvaComboCommand implements Command,
	...
	public synchronized RequestDispatcherInt execute(RequestHelper helper)
		...
		try {
			...
			AbstractBaseTableModel model = (AbstractBaseTableModel) TableCombinazioni
			...
			if (model.getRowCount() != 0) {
				...
				bDelegate.salvaCombo(model.getRowData());
			}
