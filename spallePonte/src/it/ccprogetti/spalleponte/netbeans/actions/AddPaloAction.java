...
public final class AddPaloAction extends CallableSystemAction {
    
    private DefaultController controller = new DefaultController();
    
    private String actionCommand = "addPalo";       
    ...
    public String getName() {
        return NbBundle.getMessage(AddPaloAction.class, "CTL_AddPaloAction");
    }
