...
public final class RemoveVerticaleAction extends CallableSystemAction {
    
    private DefaultController controller = new DefaultController();
    
    private String actionCommand = "removeVerticale";       
    ...
    public String getName() {
        return NbBundle.getMessage(RemoveVerticaleAction.class, "CTL_removeVerticaleAction");
    }
