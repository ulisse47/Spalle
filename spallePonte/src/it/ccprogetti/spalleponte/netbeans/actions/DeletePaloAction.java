...
public final class DeletePaloAction extends CallableSystemAction {
    
    private DefaultController controller = new DefaultController();
    
    private String actionCommand = "deletePalo";       
    ...
    public String getName() {
        return NbBundle.getMessage(DeletePaloAction.class, "CTL_DeletePaloAction");
    }
