...
public final class EliminaAppoggioAction extends CallableSystemAction {
               
    private DefaultController controller = new DefaultController();
    
    private String actionCommand = "deleteAppoggio";       
    ...
    public String getName() {
        return NbBundle.getMessage(EliminaAppoggioAction.class, "CTL_EliminaAppoggioAction");
    }
